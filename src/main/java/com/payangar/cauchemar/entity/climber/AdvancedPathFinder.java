...
/**
 * Post-processes the raw A* result into a sided path: it retraces the node sequence assigning each
 * node the surface side the spider should walk on, inserting transitional nodes when the path turns
 * a corner onto a perpendicular face. This is what turns a list of positions into a walkable
 * wall/ceiling route. Ported from Nyf's Spiders.
 */
