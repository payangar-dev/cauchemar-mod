...
/**
 * Jump control that lets the spider jump along an arbitrary surface direction (e.g. to round a
 * corner onto a perpendicular face), not just straight up. Ported from Nyf's Spiders.
 */
