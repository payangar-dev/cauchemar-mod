...
/**
 * The concrete navigator used by the Mother Spider: a climbing navigator that also keeps moving
 * toward the last target after the path completes (vanilla MC-94054 fix), so the spider does not
 * stall just short of its goal. Ported from Nyf's Spiders.
 */
