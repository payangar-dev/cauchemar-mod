...
/**
 * A minimal 4x4 matrix with an axis-angle constructor, used to build the climbing entity's
 * surface-relative basis. Ported verbatim from Nyf's Spiders (self-contained 1.20.4). Kept as a
 * standalone class (rather than JOML) to match the original behaviour exactly. Named with a
 * {@code Climber} prefix to avoid clashing with {@code org.joml.Matrix4f} / {@code com.mojang.math}.
 */
public class ClimberMatrix4f {
    public float m00, m01, m02, m03;
    public float m10, m11, m12, m13;
    public float m20, m21, m22, m23;
    public float m30, m31, m32, m33;

    public ClimberMatrix4f() {
        this.m00 = this.m11 = this.m22 = this.m33 = 1;
    }

    public ClimberMatrix4f(float angle, float x, float y, float z) {
        this();
    ...
    public void multiply(ClimberMatrix4f m) {
