...
/**
 * Turns nearby collision boxes into a smoothed surface normal + attachment point, by building an
 * ellipsoid signed-distance field from the boxes and raymarching it; the SDF gradient at the
 * converged point is the smoothed surface normal. Ported verbatim from Nyf's Spiders
 * (self-contained 1.20.4). Pure math + collision-box input, no version-specific behaviour.
 */
